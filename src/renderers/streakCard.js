...
>
  ...
  <!-- Divider Lines -->
  <line class="divider" x1="165" y1="35" x2="165" y2="140" />
  <line class="divider" x1="330" y1="35" x2="330" y2="140" />

  <!-- Block 1: Total Contributions -->
  <g class="fade-in" style="animation-delay: 150ms" transform="translate(82.5, 40)">
    ...
    <text x="0" y="42" text-anchor="middle" class="stat-number" dominant-baseline="central">${formatNumber(totalContributions)}</text>
    <text x="0" y="68" text-anchor="middle" class="stat-label" dominant-baseline="central">Total Contributions</text>
    <text x="0" y="86" text-anchor="middle" class="stat-range" dominant-baseline="central">${escapeXml(streakRange)}</text>
  </g>
  ...
  <g class="fade-in" style="animation-delay: 450ms" transform="translate(412.5, 40)">
    <!-- Crown / Zap Icon -->
    <svg x="-10" y="0" fill="${theme.icon_color}" height="20" width="20" viewBox="0 0 16 16">
    ...
    <text x="0" y="42" text-anchor="middle" class="stat-number" dominant-baseline="central">${formatNumber(longestStreak)}</text>
    <text x="0" y="68" text-anchor="middle" class="stat-label" dominant-baseline="central">Longest Streak</text>
    <text x="0" y="86" text-anchor="middle" class="stat-range" dominant-baseline="central">${escapeXml(longestStreakRange || streakRange)}</text>
  </g>
</svg>`;
}
